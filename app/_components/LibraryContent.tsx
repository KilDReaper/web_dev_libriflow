  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-10">
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight mb-6">Digital Library</h1>
          ...
          <div className="flex gap-3">
            ...
            />
            <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-xl font-semibold transition-all shadow-md shadow-indigo-100">
              Search
            </button>
          </div>
        </div>
